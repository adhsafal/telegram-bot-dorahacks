      ...
      <div className="w-full h-full flex gap-5 flex-col items-center">
        <div className="w-[98%] max-w-[420px] h-fit bg-[transparent] flex flex-col rounded-2xl gap-[24px]">
          <div className="flex flex-col gap-[16px]">
            ...
            <p className=" text-base underline text-[#3E88F7] font-medium leading-normal ">
              Withdraw Balance
            </p>
          </div>
          {/* divider */}
          ...
          <div className="text-white flex flex-col gap-[16px]">
            <p className="text-sm font-normal leading-normal text-[#919499]">Active Ticket</p>
          ...
          <div className="text-white flex flex-col gap-[16px]">
            <p className="text-sm font-normal leading-normal text-[#919499]">Winning</p>
